    ...
    return (
      <div className="min-h-screen bg-zinc-900 flex items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <h1 className="text-3xl font-bold text-zinc-100 mb-3">Results Coming July 3, 2026</h1>
          <p className="text-zinc-400 mb-8">The KRML 250 list hasn&apos;t been announced yet. Check back on reveal day!</p>
          <Countdown />
    ...
    <div className="min-h-screen bg-zinc-900 px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="text-amber-500 text-sm font-semibold uppercase tracking-widest mb-2">KRML 250 — Official Results</div>
          <h1 className="text-4xl font-bold text-zinc-100 mb-2">The Soundtrack of the Monterey Bay</h1>
          <p className="text-zinc-400">Revealed July 3, 2026</p>
        </div>
        {top5 && (
          <div className="mb-10">
            <h2 className="text-xl font-bold text-amber-400 mb-4 text-center">✨ The Top 5</h2>
            <div className="space-y-3">
              {top5.map((entry) => (
                <div key={entry.song.id} className="flex items-center gap-4 bg-amber-500/10 border border-amber-500/40 rounded-xl px-5 py-4">
                  <span className="text-3xl font-bold text-amber-400 w-10 text-center">#{entry.rank}</span>
                  <div>
                    <div className="text-zinc-100 font-bold text-lg">{entry.song.canonical_title}</div>
        ...
        {!top5Revealed && (
          <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-6 text-center mb-8">
            <div className="text-3xl mb-2">🔒</div>
            <p className="text-zinc-300 font-semibold">Top 5 will be revealed live on July 3</p>
            <p className="text-zinc-500 text-sm mt-1">Tune in to KRML for the announcement</p>
          </div>
        )}

  ...
  return (
    <div className="min-h-screen bg-[#F5F3EF] px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <h1 className="font-serif text-3xl font-bold text-[#1F1F1F] mb-2">Official Rules</h1>
        <p className="text-[#6B6560] mb-8">KRML 250 — The Soundtrack of the Monterey Bay</p>
        <div className="prose max-w-none space-y-8 text-[#3A3530]">
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">1. Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">2. How to Participate</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">3. Song Selection</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">4. Ranking Methodology</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">5. Editing Submissions</h2>
            <p>Each participant may change one of their three nominated songs, one time only, before nominations close.</p>
          </section>
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">6. Prediction Contest</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">7. Reveal Date</h2>
            <p>The KRML 250 list will be revealed on <strong className="text-amber-400">July 3, 2026</strong>, on-air and at KRML.com.</p>
          </section>
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">8. Privacy</h2>
          ...
          <section>
            <h2 className="text-xl font-serif font-bold text-[#2F5D62] mb-3">9. Modifications</h2>
